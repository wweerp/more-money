<template>
    <div class="numberPad">
        ...
        <div class="buttons">
            <button @click="inputContext">1</button>
            <button @click="inputContext">2</button>
            <button @click="inputContext">3</button>
            <button @click="remove">删除</button>
            <button @click="inputContext">4</button>
            <button @click="inputContext">5</button>
            <button @click="inputContext">6</button>
